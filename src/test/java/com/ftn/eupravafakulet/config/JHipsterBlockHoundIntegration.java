package com.ftn.eupravafakulet.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.ftn.eupravafakulet.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.ftn.eupravafakulet.security.DomainUserDetailsService", "createSpringSecurityUser");
